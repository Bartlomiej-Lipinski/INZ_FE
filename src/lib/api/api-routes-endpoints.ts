export const API_ROUTES = {
    ...
    POST_UPDATE_EVENT_DELETE_AVAILABILITY: '/api/group/availabilities',
    POST_UPDATE_DELETE_EVENT_AVAILABILITY_RANGE: '/api/group/availability',
    CALCULATE_BEST_DATE: '/api/group/events/calculateBestDate',
    CHOOSE_BEST_EVENT_DATE: '/api/group/events/chooseBestDate',
    GET_GROUP_EVENTS: '/api/group/events/eventsPerGroup',
